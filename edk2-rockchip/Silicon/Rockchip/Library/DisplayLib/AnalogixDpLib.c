  ...
  )
{
      ...
      (Dp->LinkTrain.LinkRate != DP_LINK_BW_5_4))
  {
    DEBUG ((
      DEBUG_WARN,
      "faiied to get Rx Max Link Rate  0x%2x \n",
  ...
  )
{
  ...
  Retval = AnalogixDpWriteBytesToDpcd (
             Dp,
             DP_DOWNSPREAD_CTRL,
             2,
             Buf
  ...
  Retval = AnalogixDpWriteByteToDpcd (
             Dp,
             DP_TRAINING_PATTERN_SET,
  ...
  )
{
  ...
  Retval = AnalogixDpReadBytesFromDpcd (
             Dp,
             DP_LANE0_1_STATUS,
             2,
             LinkStatus
  ...
  )
{
  ...
  Retval = AnalogixDpReadByteFromDpcd (
             Dp,
  ...
  if (!AnalogixDpChannelEqOk (LinkStatus, LinkAlign, LaneCount)) {
    ...
    DEBUG ((
      DEBUG_WARN,
      "Final link rate = 0x%.2x, Lane count = 0x%.2x\n",
      Dp->LinkTrain.LinkRate,
      Dp->LinkTrain.LaneCount
      ));
  ...
  )
{
  ...
  Ret = AnalogixDpSetLinkTrain (
          Dp,
          Dp->VideoInfo.MaxLaneCount,
